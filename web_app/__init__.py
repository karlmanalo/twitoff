...
# DATABASE_URI = "sqlite:////Users/mjr/Desktop/twitoff-14/twitoff_development_14.db" # using absolute filepath on Mac (recommended)
...
def create_app():
    ...
    DATABASE_URI = "sqlite:///C:\\Users\\Karl\\Documents\\lambda\\u3s3\\twitoff\\twitoff_development.db" # using relative filepath
